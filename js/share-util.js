...
// drift trails, baked QR, "Can you beat it?"); these anchors place the DYNAMIC layer on top.
// Left texts are absolute from the left edge; the car anchors its RIGHT rear corner to the edges.
export const CARD = {
  w: 1080, h: 1080,
