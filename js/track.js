...
const PLACED_ITEMS = [
  // Левый изгиб — трек идёт с юга на север, нож лежит почти вертикально
  { ...ITEM_KNIFE_1,      x: -1211, y:  -255, ang:  1.4  },
  // Широкий кармман слева — крупная тарелка (круглая, угол не важен)
  { ...ITEM_PLATE_YELLOW, x:  -831, y:     5, ang:  0    },
  // Верхний левый угол — степлер наискосок
  { ...ITEM_STAPLER,      x:  -491, y:  -430, ang: -0.6  },
  // Центр левой части — чашка (круглая)
  { ...ITEM_CUP,          x:  -285, y:   141, ang:  0    },
  // Нижняя прямая — вилка вдоль трека (трек почти горизонтален)
  { ...ITEM_FORK_1,       x:  -220, y:   621, ang:  0.2  },
  // Верхняя внутренняя часть — канцелярский нож под небольшим углом
  { ...ITEM_CUTTER,       x:  -200, y:  -619, ang: -0.3  },
  // Самый верх карты — блокнот почти горизонтально
  { ...ITEM_NOTEBOOK,     x:    39, y:  -853, ang:  0.15 },
  // Правый верхний — карандаш+нож по диагонали
  { ...ITEM_PENCIL_PLUS,  x:   420, y:  -500, ang: -0.7  },
  // Правый изгиб — клипборд вдоль правой стенки
  { ...ITEM_CLIPBOARD,    x:   884, y:  -253, ang:  0.35 },
];
