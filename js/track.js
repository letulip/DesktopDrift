...
const PLACED_ITEMS = [
  ...
  // Правый карман — клипборд горизонтально вдоль трека (трек здесь почти E–W)
  { ...ITEM_CLIPBOARD,    x:   884, y:  -420, ang:  0.1  },

  // ── Тонкие предметы в узких участках трека ───────────────────────────────
  // Внутренняя вертикальная прямая (x≈104) — карандаш вдоль секции
  { ...ITEM_PENCIL,       x:   115, y:   250, ang:  1.55 },
  // S-изгиб внутренней части — нож по касательной к повороту
  { ...ITEM_KNIFE_2,      x:    75, y:  -380, ang:  1.45 },
  // Нижняя дуга внутреннего кольца — циркуль под небольшим углом
  { ...ITEM_COMPASS_1,    x:   -90, y:  -570, ang:  0.35 },
];
