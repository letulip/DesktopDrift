...
// ─────────────────────────────────────────────────────────────────────────────
// Предметы из items/ — позиции заданы вручную в игровых координатах
// (изначально сняты с авторского setup-макета; теперь зашиты ниже).
// ─────────────────────────────────────────────────────────────────────────────
export const props = [];
const addProp = (o) => { props.push(prepProp(o)); }

// x,y — позиция в игровых координатах
